...
public class MockCatalogFactory {
    ...
    public Catalog createMockCatalog() {
        ...
        potatoes.setDescription("The potato is a root vegetable native to the Americas, a starchy tuber of the plant Solanum tuberosum, and the plant itself, a perennial in the family Solanaceae.[2]" + LS +
                LS +
