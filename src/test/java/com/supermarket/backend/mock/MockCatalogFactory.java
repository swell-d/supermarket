...
public class MockCatalogFactory {
    ...
    public Catalog createMockCatalog() {
        ...
        Product potatoes = new Product("Potatoes", "Potatoes", MeasurementUnit.Kilo);
        ...
        Product phone = new Product("Phone", "Phone", MeasurementUnit.Each);
        ...
        Product bag = new Product("Bag", "Bag", MeasurementUnit.Each);
